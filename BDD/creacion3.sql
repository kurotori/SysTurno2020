...
/* n turno asociado con n medicamento */
CREATE TABLE Asociado (
  id int(11) unsigned NOT NULL unique auto_increment primary key,
  turno_id int(11) unsigned NOT NULL, 
  medicamento_id int(11) unsigned NOT NULL, 
  medicamento_cant int(3) unsigned DEFAULT NULL
);
...
CREATE TABLE Contiene (
  ...
  entregado enum('si','no') default 'no' /* Esta información se actualizaría en la farmacia */
);
